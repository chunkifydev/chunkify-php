 ...
 * }
 */
final class Jpg implements BaseModel
{
    /** @use SdkModel<JpgShape> */
    use SdkModel;
    ...
    /**
     * `new Jpg()` is missing required properties by the API.
     *
