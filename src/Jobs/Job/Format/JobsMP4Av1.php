...
use Chunkify\Jobs\MP4Av1\Channels;
use Chunkify\Jobs\MP4Av1\Level;
use Chunkify\Jobs\MP4Av1\Pixfmt;
use Chunkify\Jobs\MP4Av1\Preset;
use Chunkify\Jobs\MP4Av1\Profilev;

/**
 * FFmpeg encoding parameters specific to MP4 with AV1 encoding.
 *
 * @phpstan-type JobsMP4Av1Shape = array{
 *   id: 'mp4_av1',
 ...
 * }
 */
final class JobsMP4Av1 implements BaseModel
{
    /** @use SdkModel<JobsMP4Av1Shape> */
    use SdkModel;

    /** @var 'mp4_av1' $id */
    #[Required]
    public string $id = 'mp4_av1';
