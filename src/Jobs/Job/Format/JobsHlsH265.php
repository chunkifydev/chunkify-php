...
use Chunkify\Jobs\HlsH265\Channels;
use Chunkify\Jobs\HlsH265\HlsSegmentType;
use Chunkify\Jobs\HlsH265\Level;
use Chunkify\Jobs\HlsH265\Pixfmt;
use Chunkify\Jobs\HlsH265\Preset;
use Chunkify\Jobs\HlsH265\Profilev;

/**
 * FFmpeg encoding parameters specific to HLS with H.265 encoding.
 *
 * @phpstan-type JobsHlsH265Shape = array{
 *   id: 'hls_h265',
 ...
 * }
 */
final class JobsHlsH265 implements BaseModel
{
    /** @use SdkModel<JobsHlsH265Shape> */
    use SdkModel;

    /** @var 'hls_h265' $id */
    #[Required]
    public string $id = 'hls_h265';
