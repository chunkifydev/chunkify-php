...
use Chunkify\Jobs\MP4H264\Channels;
use Chunkify\Jobs\MP4H264\Level;
use Chunkify\Jobs\MP4H264\Pixfmt;
use Chunkify\Jobs\MP4H264\Preset;
use Chunkify\Jobs\MP4H264\Profilev;

/**
 * FFmpeg encoding parameters specific to MP4 with H.264 encoding.
 *
 * @phpstan-type JobsMP4H264Shape = array{
 *   id: 'mp4_h264',
 ...
 * }
 */
final class JobsMP4H264 implements BaseModel
{
    /** @use SdkModel<JobsMP4H264Shape> */
    use SdkModel;

    /** @var 'mp4_h264' $id */
    #[Required]
    public string $id = 'mp4_h264';
