...
use Chunkify\Jobs\HlsAv1\Channels;
use Chunkify\Jobs\HlsAv1\HlsSegmentType;
use Chunkify\Jobs\HlsAv1\Level;
use Chunkify\Jobs\HlsAv1\Pixfmt;
use Chunkify\Jobs\HlsAv1\Preset;
use Chunkify\Jobs\HlsAv1\Profilev;
 ...
 *
 * @phpstan-type JobsHlsAv1Shape = array{
 *   id: 'hls_av1',
 ...
 * }
 */
final class JobsHlsAv1 implements BaseModel
{
    /** @use SdkModel<JobsHlsAv1Shape> */
    use SdkModel;

    /** @var 'hls_av1' $id */
    #[Required]
    public string $id = 'hls_av1';
